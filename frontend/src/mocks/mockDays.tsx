import { Habit, Unit } from "@models";
import { getWeekDetails, getWeekDateArray } from "@utils";

const { week_number: currentWeekNumber } = getWeekDetails();
...
export const mockDaysRecord: Habit["days"] = {
  [`${thisWeek[0]}`]: {
    _id: "f391e3a9cdf72083a718ae95",
    habit_id: "29f8424c32b86011633c0a6e",
    date: thisWeek[0],
    measurement: { quantity: 99, unit: Unit.TIME },
  },
  [`${thisWeek[1]}`]: {
    _id: "797f4ce34401fbc485610f48",
    habit_id: "29f8424c32b86011633c0a6e",
    date: thisWeek[0],
    measurement: { quantity: 15654, unit: Unit.TIME },
  },
  [`${thisWeek[2]}`]: {
    _id: "e8f1d2127596ab17d08b6eae",
    habit_id: "29f8424c32b86011633c0a6e",
    date: thisWeek[0],
    measurement: { quantity: 99, unit: Unit.TIME },
  },
  ...
  [`${thisWeek[4]}`]: {
    ...
    habit_id: "29f8424c32b86011633c0a6e",
    date: thisWeek[0],
    measurement: { quantity: 360, unit: Unit.TIME },
  },
  [`${thisWeek[5]}`]: {
    _id: "ca6c5e0cad52ac0313fbbebe",
    habit_id: "29f8424c32b86011633c0a6e",
    date: thisWeek[0],
    measurement: { quantity: 54, unit: Unit.TIME },
  },
  [`${thisWeek[6]}`]: {
    _id: "585968bd50d8a24274e8c5ee",
    habit_id: "29f8424c32b86011633c0a6e",
    date: thisWeek[0],
    measurement: { quantity: 447, unit: Unit.TIME },
  },
  [`${nextWeek[0]}`]: {
    _id: "b19c866f7f14ac8e60dafc33",
    habit_id: "29f8424c32b86011633c0a6e",
    date: thisWeek[0],
    measurement: { quantity: 123, unit: Unit.TIME },
  },
};
